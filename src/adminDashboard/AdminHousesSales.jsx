...
export default function AdminHousesSales({ onBack }) {
  ...
  const fetchHouses = async () => {
    try {
      ...
      const endpoint =
        filter === "approved"
          ? "/admin/houses/sale/approved"
          : "/admin/houses/sale/pending";
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between gap-4 mb-6">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="pl-10 bg-gray-800 text-gray-200 px-4 py-2 rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
          />
        </div>
      </div>
