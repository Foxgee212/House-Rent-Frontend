...
export default function Landlords({ onDataChange }) {
    ...
    // ✅ Fetch all users
      const fetchUsers = async () => {
        ...
        setError("");   
        try {
          const res = await API.get("/admin/users/landlords");
          setUsers(res.data);
            ...
            {filtered.map((u) => {
              ...
              return (
                ...
                >
                  {u.profilePic ? (
                    <img
                      src={u.profilePic || `https://ui-avatars.com/api/?name=${encodeURIComponent(
                        u?.name || "User"
